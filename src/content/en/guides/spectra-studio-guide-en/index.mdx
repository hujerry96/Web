...
- **Session files**: save & restore your complete workspace — samples, processing results, fits and style settings in one `.ssession` file (data embedded, compressed)
...
**Pro is already complete**: every Pro feature is finished and built into the v2.0.1 installer — nothing extra to download. After purchase, paste the key you receive by email under "🔑 Unlock Pro" in the app (one online verification on first activation, offline afterwards).

[🛒 Buy Pro on Gumroad ($79 one-time)](https://jerryhome6.gumroad.com/l/rvymku)
...
1. **Setup program** (recommended): [Download SpectraStudio-Setup-v2.0.1.exe (120 MB)](https://github.com/hujerry96/Web/releases/latest/download/SpectraStudio-Setup-v2.0.1.exe), double-click to install into the current user's directory (no administrator rights needed), with Start-menu shortcut and uninstaller.
2. **Portable build**: [Download SpectraStudio-v2.0.1-portable.exe (120 MB)](https://github.com/hujerry96/Web/releases/latest/download/SpectraStudio-v2.0.1-portable.exe) and double-click to run.
...
- Setup `SpectraStudio-Setup-v2.0.1.exe`: `52bc24caa78ccf7cbe21ccb312b397a8a2f3d5742b59f5e33ab79344751956a9`
- Portable `SpectraStudio-v2.0.1-portable.exe`: `6720460eac64c8c9d993c29c51681d19e605d41fa9c158ee79bbc2ee2f4aca41`
...
After purchasing on [Gumroad](https://jerryhome6.gumroad.com/l/rvymku), your receipt email contains a key (`XXXX-XXXX-...`). Click "🔑 Unlock Pro" in the sidebar, paste the key, and the features unlock immediately (one online verification on first activation, offline afterwards) — no reinstall needed.

...
import scene4miller from './scene_4_style_miller.png';
import scene2 from './scene_2_fit_done.png';
import scene7 from './scene_7_grain_size.png';
import outputFig from './spectra-studio-output.png';
...
Real outputs from real data — every figure below was made in Spectra Studio, from raw instrument files:

<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.1rem', margin: '1rem 0' }}>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene4} alt="Journal-style XRD figure: six stacked scans in ACS style" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>ACS journal style — six samples stacked and offset, submission-ready.</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene4miller} alt="Journal figure with (hkl) Miller indices annotated on each peak" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>Phase matching — (hkl) Miller indices annotated directly on the peaks.</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene2} alt="Peak fitting result with residuals panel" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>Peak fitting — fitted components with a residuals panel.</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene7} alt="Crystallite size report: Scherrer table and Williamson-Hall plot" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>Crystallite-size report — Scherrer table + Williamson–Hall plot (D, ε, R²).</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={outputFig} alt="A finished exported figure from Spectra Studio" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>A finished export — straight from Spectra Studio, watermark-free.</figcaption>
  </figure>

</div>

### More real exported outputs

A second set of finished figures from the supplied sample files:

<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '0.9rem', margin: '1rem 0 1.5rem' }}>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery01} alt="Real exported figure 01 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 01</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery02} alt="Real exported figure 02 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 02</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery03} alt="Real exported figure 03 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 03</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery04} alt="Real exported figure 04 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 04</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery05} alt="Real exported figure 05 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 05</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery06} alt="Real exported figure 06 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 06</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery07} alt="Real exported figure 07 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 07</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery08} alt="Real exported figure 08 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 08</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery09} alt="Real exported figure 09 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 09</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery10} alt="Real exported figure 10 from Spectra Studio" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>Real exported output 10</figcaption></figure>
</div>
...
- **Setup program** (recommended): [Download SpectraStudio-Setup-v2.1.4.exe (120 MB)](https://github.com/hujerry96/Web/releases/download/v2.1.4/SpectraStudio-Setup-v2.1.4.exe) — double-click to install into the current user's directory (no administrator rights needed), with a Start-menu shortcut and uninstaller.
- **Portable build**: [Download SpectraStudio-v2.1.4-portable.exe (119 MB)](https://github.com/hujerry96/Web/releases/download/v2.1.4/SpectraStudio-v2.1.4-portable.exe) — double-click to run, no installation.

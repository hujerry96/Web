...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.1rem', margin: '1rem 0' }}>
  ...
  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)' }}>
    <img src="./scene_0_main.png" alt="Raw spectral data freshly loaded into Spectra Studio" style={{ width: '100%', display: 'block' }} />
  ...
  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)' }}>
    <img src="./scene_4_journal.png" alt="The same data exported as a journal-style figure" style={{ width: '100%', display: 'block' }} />
...
- **Download**: [Latest release on GitHub](https://github.com/hujerry96/Web/releases) — the newest version always ships there first.

...
![AlN XRD 峰部放大圖，顯示半高線與測得的 FWHM。](../spectra-studio-guide/examples/xrd-peak-width.png)
...
![XRD 相別比對結果，包含參考卡、相別與 Miller index 標註。](../spectra-studio-guide/examples/xrd-phase-matching.png)

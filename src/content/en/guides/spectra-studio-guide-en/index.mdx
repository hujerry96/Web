...
<div style={{ columns: '3 260px', columnGap: '0.9rem', margin: '1rem 0 1.5rem' }}>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery01} alt="Real exported figure 01 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 01</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery02} alt="Real exported figure 02 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 02</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery03} alt="Real exported figure 03 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 03</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery04} alt="Real exported figure 04 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 04</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery05} alt="Real exported figure 05 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 05</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery06} alt="Real exported figure 06 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 06</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery07} alt="Real exported figure 07 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 07</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery08} alt="Real exported figure 08 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 08</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery09} alt="Real exported figure 09 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 09</figcaption>
  </figure>
  <figure style={{ breakInside: 'avoid', margin: '0 0 0.9rem', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff', boxShadow: '0 6px 20px rgba(15,23,42,0.08)' }}>
    <div style={{ position: 'relative', background: '#fff' }}>
      <Image src={gallery10} alt="Real exported figure 10 from Spectra Studio" style={{ width: '100%', height: 'auto', display: 'block' }} />
    ...
    <figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.78rem', color: 'var(--color-text-secondary)' }}>Output 10</figcaption>
  </figure>
</div>

...
- **安裝程式（建議）**：[下載 SpectraStudio-Setup-v2.1.2.exe（120 MB）](https://github.com/hujerry96/Web/releases/download/v2.1.2/SpectraStudio-Setup-v2.1.2.exe)——雙擊安裝到目前使用者目錄（不需管理員權限），含開始功能表捷徑與解除安裝程式
- **免安裝版**：[下載 SpectraStudio-v2.1.2-portable.exe（119 MB）](https://github.com/hujerry96/Web/releases/download/v2.1.2/SpectraStudio-v2.1.2-portable.exe)——雙擊直接執行，不需安裝

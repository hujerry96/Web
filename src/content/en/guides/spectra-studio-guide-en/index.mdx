...
- **Setup program** (recommended): [Download SpectraStudio-Setup-v2.1.3.exe (120 MB)](https://github.com/hujerry96/Web/releases/download/v2.1.3/SpectraStudio-Setup-v2.1.3.exe) — double-click to install into the current user's directory (no administrator rights needed), with a Start-menu shortcut and uninstaller.
- **Portable build**: [Download SpectraStudio-v2.1.3-portable.exe (119 MB)](https://github.com/hujerry96/Web/releases/download/v2.1.3/SpectraStudio-v2.1.3-portable.exe) — double-click to run, no installation.

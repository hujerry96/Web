...
以下每一張都是 Spectra Studio 從原始儀器檔直接做出來的真實成品：
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.1rem', margin: '1rem 0' }}>
  ...
  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene4} alt="期刊樣式 XRD 圖：六組掃描以 ACS 樣式堆疊" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>ACS 期刊樣式 — 六組樣品堆疊偏移，直接可投稿。</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene4miller} alt="期刊圖上直接標註 (hkl) Miller 指數" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>相位比對 — (hkl) Miller 指數直接標在峰上。</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene2} alt="分峰擬合結果含殘差面板" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>分峰擬合 — 擬合分量加上殘差面板。</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={scene7} alt="晶粒尺寸報告：Scherrer 表與 Williamson-Hall 圖" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>晶粒尺寸報告 — Scherrer 表 + Williamson–Hall 圖（D、ε、R²）。</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}>
    <Image src={outputFig} alt="Spectra Studio 匯出的完成品圖" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>匯出成品 — 直接出自 Spectra Studio，無浮水印。</figcaption>
  </figure>
...
以下是使用提供的範例檔案製作出的另一組完成品：

<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '0.9rem', margin: '1rem 0 1.5rem' }}>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery01} alt="Spectra Studio 真實匯出成品 01" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 01</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery02} alt="Spectra Studio 真實匯出成品 02" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 02</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery03} alt="Spectra Studio 真實匯出成品 03" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 03</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery04} alt="Spectra Studio 真實匯出成品 04" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 04</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery05} alt="Spectra Studio 真實匯出成品 05" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 05</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery06} alt="Spectra Studio 真實匯出成品 06" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 06</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery07} alt="Spectra Studio 真實匯出成品 07" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 07</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery08} alt="Spectra Studio 真實匯出成品 08" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 08</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery09} alt="Spectra Studio 真實匯出成品 09" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 09</figcaption></figure>
  <figure style={{ margin: 0, borderRadius: '10px', overflow: 'hidden', border: '1px solid var(--color-border)', background: '#fff' }}><Image src={gallery10} alt="Spectra Studio 真實匯出成品 10" style={{ width: '100%', display: 'block' }} /><figcaption style={{ padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--color-text-secondary)' }}>真實匯出成品 10</figcaption></figure>
</div>

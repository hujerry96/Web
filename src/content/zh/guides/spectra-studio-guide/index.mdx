...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.1rem', margin: '1rem 0' }}>
  ...
  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)' }}>
    <Image src={scene0} alt="剛載入 Spectra Studio 的原始光譜數據" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>剛載入 — 六組 XRD 原始掃描，又吵又沒格式。</figcaption>
  </figure>

  <figure style={{ margin: 0, borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--color-border)' }}>
    <Image src={scene4} alt="同一份數據匯出為期刊樣式圖" style={{ width: '100%', display: 'block' }} />
    <figcaption style={{ padding: '0.6rem 0.9rem', fontSize: '0.88rem', color: 'var(--color-text-secondary)' }}>同一份數據，十分鐘後 — 堆疊、去基線、ACS 樣式。</figcaption>
  </figure>

...
**Pro 版已經完成**：所有 Pro 功能都已開發完畢並內建在 v2.0.2 安裝檔中，不需要另外下載。購買 Pro 金鑰後，在程式內「🔑 解鎖 Pro」貼上金鑰即可立即啟用（需連網驗證一次，之後離線使用）。
...
1. **安裝程式**（推薦）：[下載 SpectraStudio-Setup-v2.0.2.exe（120 MB）](https://github.com/hujerry96/Web/releases/latest/download/SpectraStudio-Setup-v2.0.2.exe)，雙擊執行，安裝至目前使用者目錄（不需管理員權限），並提供開始功能表捷徑與解除安裝程式。
2. **免安裝版**：[下載 SpectraStudio-v2.0.2-portable.exe（120 MB）](https://github.com/hujerry96/Web/releases/latest/download/SpectraStudio-v2.0.2-portable.exe)，雙擊即可執行。
...
- 安裝程式 `SpectraStudio-Setup-v2.0.2.exe`：`29e168a94eb30ce6f817476b442a2cde04ba0f8cd3af1b12fcac7e4e50e05077`
- 免安裝版 `SpectraStudio-v2.0.2-portable.exe`：`aa0a79d1903aba3f517f9905a24ea7bea760d5754d5af494c1dd0f53540e9396`

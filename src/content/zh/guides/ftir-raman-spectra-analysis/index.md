...
![使用資料夾中的範例資料製作的 FTIR 光譜圖。](../spectra-studio-guide/examples/ftir-spectrum.png)
...
![FTIR 峰偵測結果，標出候選特徵峰。](../spectra-studio-guide/examples/ftir-peak-detection.png)
...
![使用資料夾中的範例資料製作的 Raman 光譜圖。](../spectra-studio-guide/examples/raman-spectrum.png)
